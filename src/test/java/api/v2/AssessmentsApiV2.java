...
public interface AssessmentsApiV2 {
    ...
    @PUT("api/v2/assessments" + "/<built-in function id>")
    Call<ResponseBody> update(@Path("id") String id, @Body Object body);

    @DELETE("api/v2/assessments" + "/<built-in function id>")
