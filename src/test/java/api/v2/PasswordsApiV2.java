...
public interface PasswordsApiV2 {
    ...
    @PUT("api/v2/passwords" + "/<built-in function id>")
    Call<ResponseBody> update(@Path("id") String id, @Body Object body);

    @DELETE("api/v2/passwords" + "/<built-in function id>")
    Call<ResponseBody> destroy(@Path("id") String id);

    @GET("api/v2/passwords" + "/forgot")
    Call<ResponseBody> forgot(@QueryMap Map<String, Object> query);

    @GET("api/v2/passwords" + "/reset")
    Call<ResponseBody> reset(@QueryMap Map<String, Object> query);
