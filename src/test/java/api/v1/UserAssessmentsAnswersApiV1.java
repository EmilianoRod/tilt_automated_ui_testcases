...
public interface UserAssessmentsAnswersApiV1 {
    @GET("api/v1/user_assessments/answers")
    Call<ResponseBody> index(@QueryMap Map<String, Object> query);

    @GET("api/v1/user_assessments/answers" + "/<built-in function id>")
    Call<ResponseBody> show(@Path("id") String id, @QueryMap Map<String, Object> query);

    @POST("api/v1/user_assessments/answers")
    Call<ResponseBody> create(@Body Object body);

    @PUT("api/v1/user_assessments/answers" + "/<built-in function id>")
    Call<ResponseBody> update(@Path("id") String id, @Body Object body);

    @DELETE("api/v1/user_assessments/answers" + "/<built-in function id>")
